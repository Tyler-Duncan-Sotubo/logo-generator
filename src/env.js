...
export const env = createEnv({
  ...
  server: {
    ...
    PRODUCT_PRICE_ID_100: z.string(),
    PRODUCT_PRICE_ID_300: z.string(),
  ...
  runtimeEnv: {
    ...
    PRODUCT_PRICE_ID_100: process.env.PRODUCT_PRICE_ID_100,
    PRODUCT_PRICE_ID_300: process.env.PRODUCT_PRICE_ID_300,
  },
  /**
